...
/****************************************************************/
projection(HeaderP, relation(Header, Table), R) :-verifRelation(relation(Header,Table)), findIndices(HeaderP,Header,Output), keepAll(Output,Table,Final), R = relation(HeaderP,Final).
